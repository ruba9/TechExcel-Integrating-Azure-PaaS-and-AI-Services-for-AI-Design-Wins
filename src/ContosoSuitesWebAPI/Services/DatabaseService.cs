...
public class DatabaseService(string connectionString) : IDatabaseService
{
   ...
   [KernelFunction]
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all booking by hotel and date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate( [Description("The ID of the hotel")] int hotelId, [Description("The Date of booking")] DateTime dt)
    {
...
[KernelFunction]
    [Description("Get all bookings for a missing hotel rooms.")]
